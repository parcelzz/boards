# Step 5 — External source evaluation (generated)

> **Summary:** Auto-generated seed for Step 5 external-source evaluation from Step 1 priorities. Complete using the Step 5 template after Step 4 workshop sign-off.  
