<!-- Suggested GitHub issue TITLE (separate from description): Build Field Semantics & Literal-Value QA Report (Step 3) -->
...
| **Operator / handoff doc** | `docs/field_semantics_step3.md` |
| **Ticket writeup / checklist** | `docs/ticket_03_step3_field_semantics.md` (this file) |
...
- **Step 4:** Product field review (`docs/product_field_review_template.md`) with P0–P3 and “OK if unknown?” decisions backed by counts
